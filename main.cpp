...
int main()
{
    ...
    //future<int> r7 = pool.submitTask([](int b, int e)->int {
    //    int sum = 0;
    //    for (int i = b; i <= e; i++)
    //        sum += i;
    //    return sum;
    //    }, 1, 100);
    //future<int> r8 = pool.submitTask([](int b, int e)->int {
    //    int sum = 0;
    //    for (int i = b; i <= e; i++)
    //        sum += i;
    //    return sum;
    ...
    cout << "result1：" << r1.get() << endl;
    cout << "result2：" << r2.get() << endl;
    cout << "result3：" << r3.get() << endl;
    cout << "result4：" << r4.get() << endl;
    cout << "result5：" << r5.get() << endl;
